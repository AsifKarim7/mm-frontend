const styles = {
    ...
    productPrice:"font-bold text-[18px] text-[#d55b45] font-Roboto",
    price:"font-[500] text-[16px] text-[#d55b45] pl-3 mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-[#1F1EFB] pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#1F1EFB]",
    button: 'w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#1F1EFB] flex items-center justify-center cursor-pointer",
